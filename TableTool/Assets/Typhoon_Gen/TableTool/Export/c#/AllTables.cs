...
namespace Typhoon.Excel2Json.Export
{
    ...
    public class AllTables
    {
        ...
        /// 测试
        /// </summary>
        public TableListRole role;
        /// <summary>
        /// 皮肤
        /// </summary>
        public TableListSkin skin;
        /// <summary>
        /// 简单用法
        /// </summary>
        ...
        public TableRole FindTableRoleById(int id)
        {
            return role["id", id];
        }

        public TableRole FindTableRoleByName(string name)
        {
            return role["name", name];
        }

        public TableSkin FindTableSkinById(int id)
        {
            return skin["id", id];
        }

        public TableSkin FindTableSkinByName(string name)
        {
